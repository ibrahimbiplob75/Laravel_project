                    ...
                    <div class="header-actions">
                        @Auth('customerlogin')
                            <a href="login.html" class="header-action-btn login-btn" data-bs-toggle="modal"
                               data-bs-target="#loginActive">{{Auth::guard('customerlogin')->user()->name}}
                            </a>
                        @else
                        <a href="login.html" class="header-action-btn login-btn" data-bs-toggle="modal"
                           data-bs-target="#loginActive">Sign In
                        </a>
                        @endauth
                        <!-- Single Wedge Start -->
...
<div id="offcanvas-cart" class="offcanvas offcanvas-cart">
    <div class="inner">
        ...
        <div class="body customScroll">
            <ul class="minicart-product-list">
                @foreach(App\Models\cart::where('user_id',Auth::guard('customerlogin')->id())->get() as $carts)
                <li>
                    <a href="single-product.html" class="image"><img src="{{asset('uploads/preview')}}/{{$carts->rel_to_product->product_image}}"
                                                                     alt="Cart product Image"></a>
                    <div class="content">
                        <a href="single-product.html" class="title">{{$carts->rel_to_product->product_name}}</a>
                        <span class="quantity-price">{{$carts->quantity}} x <span class="amount">{{$carts->rel_to_product->discount_price}}</span></span>
                        <a href="{{url('/cart/remove')}}/{{$carts->id}}" class="remove">X</a>
                    </div>
                </li>
                @endforeach
            </ul>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <p class="copy-text"> © 2023 <strong>Marketplace</strong> Made by <i class="fa fa-heart"
                                                                                         aria-hidden="true"></i> By <a class="company-name" href="https://hasthemes.com/">
                                <strong> Ibrahim</strong></a>.</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="modal-body">
                        <div class="login-content">
                            <form class="text-center  mt-3">
                                <a href="{{url('/myAccount')}}" style="font-size:20px;background: #0a58ca;width: 90%;height:50px;color: whitesmoke;font-weight: bold" type="submit">My Account</a>
                            </form>
                ...
                <div class="modal-body">
                    <div class="login-content">
                        ...
                        <form action="{{url('/customer/login')}}" method="POST">
                            ...
                            <button style="background: green" type="submit">Log in</button>

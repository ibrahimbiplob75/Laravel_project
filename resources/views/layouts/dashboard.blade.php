...
<div class="sl-sideleft">
    ...
    <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="{{url('/category')}}" class="nav-link">Add Category</a></li>
{{--            <li class="nav-item"><a href="{{url('/category/edit')}}" class="nav-link">Edit Category</a></li>--}}
        ...
        <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="{{url('/subCategory')}}" class="nav-link">Add sub Category</a></li>
{{--            <li class="nav-item"><a href="{{url('/subCategory/edit')}}" class="nav-link">Edit sub Category</a></li>--}}
        ...
        <ul class="sl-menu-sub nav flex-column ">
            ...
            <li class="nav-item"><a href="{{route('colorSize')}}" class="nav-link">Product color & Size</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="{{route('coupon')}}" class="nav-link">Add Coupons</a></li>
            <li class="nav-item"><a href="alerts.html" class="nav-link">Used Coupon</a></li>
        ...
        <a href="#" class="sl-menu-link">
            <div class="sl-menu-item">
                ...
                <span class="menu-item-label">Delivery Area</span>
                <i class="menu-item-arrow fa fa-angle-down"></i>
            </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="{{url('/delivery')}}" class="nav-link">Add Area</a></li>
        ...
        <nav class="nav">
            <div class="dropdown">
                <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
                    ...
                    <img src="{{asset('dashboard_assets/profile_image')}}/{{Auth::user()->photo}}" class="wd-32 rounded-circle" alt="">
                </a>
                <div class="dropdown-menu dropdown-menu-header wd-200">
                    <ul class="list-unstyled user-profile-nav">
                        <li><a href="{{url('/home/edit')}}"><i class="icon ion-ios-person-outline"></i> Edit Profile</a></li>
...
<div class="sl-mainpanel">
    <nav class="breadcrumb sl-breadcrumb">
        ...
        <a class="breadcrumb-item" >@yield('title')</a>
